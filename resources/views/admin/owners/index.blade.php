                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="md:px-4 py-3">
                                <button onclick="location.href='{{ route('admin.owners.edit', ['owner' => $owner->id ]) }}' " type="submit" class="text-white bg-indigo-400 border-0 py-2 md:px-4 focus:outline-none hover:bg-indigo-500 rounded">変更する</button>
                              </td>
