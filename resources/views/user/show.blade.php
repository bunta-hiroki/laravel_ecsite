                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="md:flex md:justify-around">
                      ...
                      <div class="md:w-1/2 md:ml-4">
                        <h2 class="mb-1 text-sm title-font text-gray-500 tracking-widest">{{ $product->category->name }}</h2>
                        ...
                        <div class="flex justify-around items-center">
                          ...
                          <form method="post" action="{{ route('user.cart.add') }}">
                            @csrf
                            <div class="ml-4 flex items-center mb-4">
                    ...
                    <div class="mb-4 text-center">
                      <button type="button" data-micromodal-trigger="modal-1" href="javascript:;" class="text-white bg-gray-500 border-0 py-2 px-6 focus:outline-none hover:bg-gray-500 rounded">ショップの詳細を見る</button>
                    </div>
      ...
      <div class="modal__overlay" tabindex="-1" data-micromodal-close>
        <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
          ...
          <footer class="modal__footer">
            <button class="modal__btn" type="button" data-micromodal-close aria-label="Close this dialog window">Close</button>
          </footer>
        </div>
      </div>
    </div>
